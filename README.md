...
- **[ide-client](https://lumine-code.github.io/docs.html#services/ide-client)** (`^1.0.0`): consumed to register the Texlab adapter with the editor's language-server client.
