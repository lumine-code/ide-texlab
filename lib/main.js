...
const texlabOptions = () => ({
  ...
  diagnostics: {
    allowedPatterns: setting("diagnostics.allowedPatterns") || [],
    ignoredPatterns: setting("diagnostics.ignoredPatterns") || [],
  },
  symbols: {
    allowedPatterns: setting("symbols.allowedPatterns") || [],
    ignoredPatterns: setting("symbols.ignoredPatterns") || [],
  },
  inlayHints: {
